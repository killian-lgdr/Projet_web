<?php
    ...
    class PDManager extends Manager
    {
        public function getDelegue()
        {
            ...
            {
                $db = $this->dbConnect();
                $req = $db->query('SELECT nom_Delegue, prenom_Delegue, localisation.nom_localisation from delegue inner join localisation on delegue.ID_Localisation = localisation.ID_localisation where delegue.nom_Delegue = "'.$_POST['nom_del'].'" AND delegue.prenom_Delegue = "'.$_POST['prenom_del'].'";');
                return $req;
            }
        }
